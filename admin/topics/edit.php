            ...
            <div class="add-post col-9">
                ...
                <div class="row post">
                    ...
                    <div class="col mt-3">
                        ...
                        <textarea class="form-control" name="content" id="contnet" rows="3"><?=$content;?></textarea>
                    </div>           
                  
                   
                    <div class="col text-center">
                        <button class="btn btn-primary mt-5 " name="topic-edit" type="submit">Bo'limni yaratish</button>
                    </div>
